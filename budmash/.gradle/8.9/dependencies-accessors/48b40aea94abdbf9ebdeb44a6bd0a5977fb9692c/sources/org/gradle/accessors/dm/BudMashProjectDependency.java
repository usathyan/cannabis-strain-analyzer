...
@NonNullApi
public class BudMashProjectDependency extends DelegatingProjectDependency {

    @Inject
    public BudMashProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
